...
visdat::vis_miss(data) + 
  labs(title = "The percentage of missing data")+theme(plot.title = element_text(size = 12, face = "bold", hjust = 0.5),axis.text.x = element_text(angle = 85))
```
...
gg_miss_var(data,
            facet = Development_Regions,show_pct = TRUE)+ labs(title = "The missing data with development regions")+theme(plot.title = element_text(size = 12, face = "bold", hjust = 0.5))
```

...
In datasets of completion rate, literacy rate and out-of school rate, worksheets are separated using `r read_excel` from `r readxl` package. Columns orther than country name, development level and indicators are all removed, leaving us a 202*4 dataset. Regional development level is categorized into 4 levels, listed sequentially: not classified, least developed, less developed, and more developed. After transforming with `r pivot_longer` (i.e, creating a categorical column for gender), each dataset is now with 404 rows and 4 columns. 

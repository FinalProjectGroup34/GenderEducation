...
```{r, include=FALSE}
data_dhs <- read.csv(file = 'dhs.csv')

data_cr_p<-read_excel('Completion_rate.xlsx', 
...
data_cr_ls<-read_excel('Completion_rate.xlsx', 
...
data_cr_us<-read_excel('Completion_rate.xlsx', 
...
data_lr_a<-read_excel('Literacy_rate.xlsx', 
...
data_lr_y<-read_excel('Literacy_rate.xlsx', 
                       sheet = "Youth literacy rate, aged 15-24",
                      col_names = c("ISO3","country","Region","Sub-region","Development_Regions","Total","Female","Male","data source","Time period"),skip = 2 )

data_os_p<-read_excel('Out_of_school_rate.xlsx', 
                       sheet = "Primary",
...
data_os_ls<-read_excel('Out_of_school_rate.xlsx', 
                       sheet ="Lower secondary",
                      col_names = c("ISO3","country","Region","Sub-region","Development_Regions","Total","Female","Male"	,"Rural","Urban","Poorest","Second","Middle","Fourth"	,"Richest","data source","Time period","Pop_total","Pop_female","Pop_male","Pop_rural","Pop_urban","Urban percentage"),skip = 2 )

data_os_us<-read_excel('Out_of_school_rate.xlsx', 
...
Eventually, we remove those rows which are NAs in all indicators. Moreover, we keep the other rows even though they also exist missing values. Since for explore relationship in gender and education, removing NAs seems unnecessary.  

...
op=par(mfrow=c(2,1))
mapCountryData(map, nameColumnToPlot="eduyears_2024_m_Female",borderCol='black',catMethod=c(1:16),colourPalette=brewer.pal(9,'YlOrBr'))
mapCountryData(map, nameColumnToPlot="eduyears_2024_m_Male",borderCol='black', catMethod=c(1:16),colourPalette=brewer.pal(9,'YlOrBr'))
```
